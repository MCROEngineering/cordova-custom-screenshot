module.exports.ScreenShotFrame = function (width, height, x, y, fileName) {
  ...
  return {
    ...
    takeASnap: function (e) {
      ...
      setTimeout(function () {
        // send this over the next runloop
        console.log(widthFrame, heightFrame, xOffset, yOffset);
        
        shooter.save(widthFrame, heightFrame, xOffset, yOffset, (error, res) => {
        
        }, 'jpg', fileName || 'screenshotName' + parseInt(Math.random() * 1000, 10) );
      }, 0);
    },
